...
for ax in axs:
    ...
    ax.legend()
fig.savefig('out/hist_numaapartitions-numcolumns.png')
plt.close()
...
for ax in axs:
    ...
    ax.legend()
fig.savefig('out/hist_numindelmodels-numcolumns.png')
plt.close()
...
fig.savefig('out/hist_numindelmodels-numcolumns_nan.png')
plt.close()
...
fig.savefig('out/hist_numregion-aarate.png')
plt.close()
...
fig.savefig('out/hist_numregion-indelrate.png')
plt.close()
...
fig.savefig('out/hist_numregion-indelrate_5.png')
plt.close()
...
fig.colorbar(hb)
fig.savefig('out/hexbin_indelrate-aarate.png')
plt.close()
