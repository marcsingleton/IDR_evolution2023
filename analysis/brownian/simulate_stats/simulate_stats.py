...
cutoffs = linspace(delta_loglikelihood_min, delta_loglikelihood_max, 50)
...
df_error = groups_OU['delta_loglikelihood'].aggregate(lambda x: (x < q99).mean()).sort_index(level=['sigma2_id', 'alpha_id'])
